        ...
        <div className="grid lg:grid-cols-[1fr_auto] gap-16 items-center">
          ...
          >
            ...
            <div className="space-y-2">
              <motion.h1
                ...
                className="text-6xl sm:text-7xl md:text-8xl lg:text-[6.5rem] font-bold leading-[0.9] tracking-[-0.04em]"
              >
          ...
          >
            <div className="relative">
              ...
              <div className="relative p-6 rounded-2xl bg-card/90 border border-border backdrop-blur-sm shimmer">
                {/* Terminal dots */}
                <div className="flex items-center gap-1.5 mb-5">
                  <div className="w-3 h-3 rounded-full bg-destructive/60" />
                  <div className="w-3 h-3 rounded-full bg-primary/40" />
                  <div className="w-3 h-3 rounded-full bg-accent/40" />
                  <span className="ml-3 text-[10px] font-mono text-muted-foreground">~/kshathishka</span>
                </div>

                <div className="font-mono text-[13px] leading-7 space-y-0.5">
                  <div>
